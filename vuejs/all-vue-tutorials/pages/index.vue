<template>
  <v-layout
    ...
    <v-flex
      ...
      <v-card>
        <v-card-title class="headline">Vue 에 대한 모든 Tutorial 입니다.</v-card-title>
        <v-card-text>
          ...
          <p>Find a bug? Report it on the github <a
            href="https://github.com/code-machina/awesome-tutorials/all-vue-tutorials"
            target="_blank"
            title="contribute">issue board</a>.</p>
          <p>Thank you for developing with Vuetify and I look forward to bringing more exciting features in the future.</p>
          <div class="text-xs-right">
            <em><small>&mdash; Code Machina (gbkim1988@gmail.com)</small></em>
          </div>
          <hr class="my-3">
          <a
